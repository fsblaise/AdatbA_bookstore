...
INSERT INTO BOOK_STORE_PRODUCT(review, type, name, production, genre) VALUES(4, 'képregény', 'Saga', '2012', 'scifi');
...
INSERT INTO BOOK_STORE_PRODUCT(review, type, name, production, genre) VALUES(5, 'képregény', 'Akira', '1982', 'scifi');
...
INSERT INTO BOOK_STORE_PRODUCT(review, type, name, production, genre) VALUES(5, 'képregény', 'Transmetropolitan', '1997', 'scifi');
...
INSERT INTO BOOK_STORE_PRODUCT(review, type, name, production, genre) VALUES(4, 'képregény', 'The Umbrella Academy', '2007', 'scifi');
...
BEGIN
    ...
    SELECT COUNT(*) INTO counter FROM BOOK_STORE_PURCHASE WHERE USER_ID = :NEW.USER_ID;

    IF counter >= 10 THEN
        UPDATE BOOK_STORE_USERS t SET t.ISREGULAR = 1 WHERE t.ID = :NEW.USER_ID;
    end if;
end;
