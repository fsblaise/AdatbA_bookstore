...
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,5,25,45,1);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,2,16,12,2);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,1,67,1,3);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,1,49,5,4);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,7,69,67,5);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,9,12,123,6);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,8,13,89,7);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,8,14,98,8);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,6,56,33,9);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,6,34,37,10);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,7,23,69,11);
Insert into book_store_stock(capacity,islow,sum,product_id,store_id) values(500,9,22,100,12);